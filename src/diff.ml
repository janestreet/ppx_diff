        ...
        tarrow_maybe
          (List.map
             ...
             ~f:(fun (row_name, row_type) : Ppxlib_jane.arrow_argument ->
               ...
               { arg_label = Optional arg_name; arg_modes = []; arg_type }))
          [%type: unit -> [%t t_]]
      in
        ...
        tarrow_maybe
          (List.map
             ...
             ~f:(fun (row_name, row_type) : Ppxlib_jane.arrow_argument ->
               ...
               in
               { arg_label = Labelled arg_name; arg_modes = [ Mode "local" ]; arg_type }))
          t_
      in
