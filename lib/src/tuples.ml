...
module Tuple2 = struct
  ...
  module Diff = struct
    ...
    let of_list_exn of_list1_exn of_list2_exn ts =
      match ts with
      | [] -> Optional_diff.get_none ()
      | _ :: _ ->
...
module Tuple3 = struct
  ...
  module Diff = struct
    ...
    let of_list_exn of_list1_exn of_list2_exn of_list3_exn ts =
      match ts with
      | [] -> Optional_diff.get_none ()
      | _ :: _ ->
        (match List.concat ts |> List.stable_sort ~compare:compare_rank with
...
module Tuple4 = struct
  ...
  module Diff = struct
    ...
    let of_list_exn of_list1_exn of_list2_exn of_list3_exn of_list4_exn ts =
      match ts with
      | [] -> Optional_diff.get_none ()
      | _ :: _ ->
        (match List.concat ts |> List.stable_sort ~compare:compare_rank with
