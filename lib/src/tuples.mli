...
module Tuple2 : sig
  ...
  module Diff : sig
    ...
    val get
      :  (from:'a1 -> to_:'a1 -> 'a1_diff Optional_diff.t @ local)
      -> (from:'a2 -> to_:'a2 -> 'a2_diff Optional_diff.t @ local)
      -> from:('a1, 'a2) derived_on
      -> to_:('a1, 'a2) derived_on
      -> ('a1_diff, 'a2_diff) t Optional_diff.t @ local
    ...
    val of_list_exn
      :  ('a1_diff list -> 'a1_diff Optional_diff.t @ local)
      -> ('a2_diff list -> 'a2_diff Optional_diff.t @ local)
    ...
    val create_of_variants
      :  t1:('a1_diff, ('a1_diff, 'a2_diff) Entry_diff.t) Of_variant.t @ local
      -> t2:('a2_diff, ('a1_diff, 'a2_diff) Entry_diff.t) Of_variant.t @ local
      -> ('a1_diff, 'a2_diff) t
  end
  ...
  module Local : sig
    ...
    module Diff : sig
      ...
      val get
        :  (from:'a1 -> to_:'a1 -> 'a1_diff Optional_diff.t @ local)
        -> (from:'a2 -> to_:'a2 -> 'a2_diff Optional_diff.t @ local)
        -> from:('a1, 'a2) derived_on @ local
        -> to_:('a1, 'a2) derived_on @ local
        -> ('a1_diff, 'a2_diff) t Optional_diff.t @ local

      val apply_exn
        :  ('a1 -> 'a1_diff -> 'a1)
        -> ('a2 -> 'a2_diff -> 'a2)
        -> ('a1, 'a2) derived_on @ local
        -> ('a1_diff, 'a2_diff) t
        -> ('a1, 'a2) derived_on @ local
...
module Tuple3 : sig
  ...
  module Diff : sig
    ...
    val get
      :  (from:'a1 -> to_:'a1 -> 'a1_diff Optional_diff.t @ local)
      -> (from:'a2 -> to_:'a2 -> 'a2_diff Optional_diff.t @ local)
      -> (from:'a3 -> to_:'a3 -> 'a3_diff Optional_diff.t @ local)
      -> from:('a1, 'a2, 'a3) derived_on
      -> to_:('a1, 'a2, 'a3) derived_on
      -> ('a1_diff, 'a2_diff, 'a3_diff) t Optional_diff.t @ local
    ...
    val of_list_exn
      :  ('a1_diff list -> 'a1_diff Optional_diff.t @ local)
      -> ('a2_diff list -> 'a2_diff Optional_diff.t @ local)
      -> ('a3_diff list -> 'a3_diff Optional_diff.t @ local)
    ...
    val create_of_variants
      :  t1:('a1_diff, ('a1_diff, 'a2_diff, 'a3_diff) Entry_diff.t) Of_variant.t @ local
      -> t2:('a2_diff, ('a1_diff, 'a2_diff, 'a3_diff) Entry_diff.t) Of_variant.t @ local
      -> t3:('a3_diff, ('a1_diff, 'a2_diff, 'a3_diff) Entry_diff.t) Of_variant.t @ local
      -> ('a1_diff, 'a2_diff, 'a3_diff) t
  end
  ...
  module Local : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a2 -> to_:'a2 -> 'a2_diff Optional_diff.t @ local)
        -> (from:'a3 -> to_:'a3 -> 'a3_diff Optional_diff.t @ local)
        -> from:('a1, 'a2, 'a3) derived_on @ local
        -> to_:('a1, 'a2, 'a3) derived_on @ local
        -> ('a1_diff, 'a2_diff, 'a3_diff) t Optional_diff.t @ local
...
module Tuple4 : sig
  ...
  module Diff : sig
    ...
    val get
      ...
      -> (from:'a2 -> to_:'a2 -> 'a2_diff Optional_diff.t @ local)
      -> (from:'a3 -> to_:'a3 -> 'a3_diff Optional_diff.t @ local)
      -> (from:'a4 -> to_:'a4 -> 'a4_diff Optional_diff.t @ local)
      -> from:('a1, 'a2, 'a3, 'a4) derived_on
      -> to_:('a1, 'a2, 'a3, 'a4) derived_on
      -> ('a1_diff, 'a2_diff, 'a3_diff, 'a4_diff) t Optional_diff.t @ local
    ...
    val of_list_exn
      ...
      -> ('a2_diff list -> 'a2_diff Optional_diff.t @ local)
      -> ('a3_diff list -> 'a3_diff Optional_diff.t @ local)
      -> ('a4_diff list -> 'a4_diff Optional_diff.t @ local)
  ...
  module Local : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a3 -> to_:'a3 -> 'a3_diff Optional_diff.t @ local)
        -> (from:'a4 -> to_:'a4 -> 'a4_diff Optional_diff.t @ local)
        -> from:('a1, 'a2, 'a3, 'a4) derived_on @ local
        -> to_:('a1, 'a2, 'a3, 'a4) derived_on @ local
        -> ('a1_diff, 'a2_diff, 'a3_diff, 'a4_diff) t Optional_diff.t @ local
...
module Tuple5 : sig
  ...
  module Diff : sig
    ...
    val get
      ...
      -> (from:'a3 -> to_:'a3 -> 'a3_diff Optional_diff.t @ local)
      -> (from:'a4 -> to_:'a4 -> 'a4_diff Optional_diff.t @ local)
      -> (from:'a5 -> to_:'a5 -> 'a5_diff Optional_diff.t @ local)
      -> from:('a1, 'a2, 'a3, 'a4, 'a5) derived_on
      -> to_:('a1, 'a2, 'a3, 'a4, 'a5) derived_on
      -> ('a1_diff, 'a2_diff, 'a3_diff, 'a4_diff, 'a5_diff) t Optional_diff.t @ local
    ...
    val of_list_exn
      ...
      -> ('a3_diff list -> 'a3_diff Optional_diff.t @ local)
      -> ('a4_diff list -> 'a4_diff Optional_diff.t @ local)
      -> ('a5_diff list -> 'a5_diff Optional_diff.t @ local)
  ...
  module Local : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a4 -> to_:'a4 -> 'a4_diff Optional_diff.t @ local)
        -> (from:'a5 -> to_:'a5 -> 'a5_diff Optional_diff.t @ local)
        -> from:('a1, 'a2, 'a3, 'a4, 'a5) derived_on @ local
        -> to_:('a1, 'a2, 'a3, 'a4, 'a5) derived_on @ local
        -> ('a1_diff, 'a2_diff, 'a3_diff, 'a4_diff, 'a5_diff) t Optional_diff.t @ local
      ...
      val apply_exn
        ...
        -> ('a4 -> 'a4_diff -> 'a4)
        -> ('a5 -> 'a5_diff -> 'a5)
        -> ('a1, 'a2, 'a3, 'a4, 'a5) derived_on @ local
        -> ('a1_diff, 'a2_diff, 'a3_diff, 'a4_diff, 'a5_diff) t
        -> ('a1, 'a2, 'a3, 'a4, 'a5) derived_on @ local
...
module Tuple6 : sig
  ...
  module Diff : sig
    ...
    val get
      ...
      -> (from:'a4 -> to_:'a4 -> 'a4_diff Optional_diff.t @ local)
      -> (from:'a5 -> to_:'a5 -> 'a5_diff Optional_diff.t @ local)
      -> (from:'a6 -> to_:'a6 -> 'a6_diff Optional_diff.t @ local)
    ...
    val of_list_exn
      ...
      -> ('a4_diff list -> 'a4_diff Optional_diff.t @ local)
      -> ('a5_diff list -> 'a5_diff Optional_diff.t @ local)
      -> ('a6_diff list -> 'a6_diff Optional_diff.t @ local)
  ...
  module Local : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a5 -> to_:'a5 -> 'a5_diff Optional_diff.t @ local)
        -> (from:'a6 -> to_:'a6 -> 'a6_diff Optional_diff.t @ local)
        -> from:('a1, 'a2, 'a3, 'a4, 'a5, 'a6) derived_on @ local
        -> to_:('a1, 'a2, 'a3, 'a4, 'a5, 'a6) derived_on @ local
        -> ('a1_diff, 'a2_diff, 'a3_diff, 'a4_diff, 'a5_diff, 'a6_diff) t Optional_diff.t
           @ local
      ...
      val apply_exn
        ...
        -> ('a5 -> 'a5_diff -> 'a5)
        -> ('a6 -> 'a6_diff -> 'a6)
        -> ('a1, 'a2, 'a3, 'a4, 'a5, 'a6) derived_on @ local
        -> ('a1_diff, 'a2_diff, 'a3_diff, 'a4_diff, 'a5_diff, 'a6_diff) t
        -> ('a1, 'a2, 'a3, 'a4, 'a5, 'a6) derived_on @ local
