...
module Tuple2 : sig
  ...
  module Diff : sig
    ...
    val get
      :  (from:'a1 -> to_:'a1 -> local_ 'a1_diff Optional_diff.t)
      -> (from:'a2 -> to_:'a2 -> local_ 'a2_diff Optional_diff.t)
      -> from:('a1, 'a2) derived_on
      -> to_:('a1, 'a2) derived_on
      -> local_ ('a1, 'a2, 'a1_diff, 'a2_diff) t Optional_diff.t
    ...
    val of_list_exn
      :  ('a1_diff list -> local_ 'a1_diff Optional_diff.t)
      -> ('a1 -> 'a1_diff -> 'a1)
      -> ('a2_diff list -> local_ 'a2_diff Optional_diff.t)
      -> ('a2 -> 'a2_diff -> 'a2)
  ...
  module For_inlined_tuple : sig
    ...
    module Diff : sig
      ...
      val get
        :  (from:'a1 -> to_:'a1 -> local_ 'a1_diff Optional_diff.t)
        -> (from:'a2 -> to_:'a2 -> local_ 'a2_diff Optional_diff.t)
        -> from:local_ ('a1, 'a2) derived_on
        -> to_:local_ ('a1, 'a2) derived_on
        -> local_ ('a1, 'a2, 'a1_diff, 'a2_diff) t Optional_diff.t

      val apply_exn
        :  ('a1 -> 'a1_diff -> 'a1)
        -> ('a2 -> 'a2_diff -> 'a2)
        -> local_ ('a1, 'a2) derived_on
        -> ('a1, 'a2, 'a1_diff, 'a2_diff) t
        -> local_ ('a1, 'a2) derived_on
...
module Tuple3 : sig
  ...
  module Diff : sig
    ...
    val get
      :  (from:'a1 -> to_:'a1 -> local_ 'a1_diff Optional_diff.t)
      -> (from:'a2 -> to_:'a2 -> local_ 'a2_diff Optional_diff.t)
      -> (from:'a3 -> to_:'a3 -> local_ 'a3_diff Optional_diff.t)
      -> from:('a1, 'a2, 'a3) derived_on
      -> to_:('a1, 'a2, 'a3) derived_on
      -> local_ ('a1, 'a2, 'a3, 'a1_diff, 'a2_diff, 'a3_diff) t Optional_diff.t
    ...
    val of_list_exn
      ...
      -> ('a2_diff list -> local_ 'a2_diff Optional_diff.t)
      -> ('a2 -> 'a2_diff -> 'a2)
      -> ('a3_diff list -> local_ 'a3_diff Optional_diff.t)
      -> ('a3 -> 'a3_diff -> 'a3)
  ...
  module For_inlined_tuple : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a2 -> to_:'a2 -> local_ 'a2_diff Optional_diff.t)
        -> (from:'a3 -> to_:'a3 -> local_ 'a3_diff Optional_diff.t)
        -> from:local_ ('a1, 'a2, 'a3) derived_on
        -> to_:local_ ('a1, 'a2, 'a3) derived_on
        -> local_ ('a1, 'a2, 'a3, 'a1_diff, 'a2_diff, 'a3_diff) t Optional_diff.t
...
module Tuple4 : sig
  ...
  module Diff : sig
    ...
    val get
      ...
      -> (from:'a2 -> to_:'a2 -> local_ 'a2_diff Optional_diff.t)
      -> (from:'a3 -> to_:'a3 -> local_ 'a3_diff Optional_diff.t)
      -> (from:'a4 -> to_:'a4 -> local_ 'a4_diff Optional_diff.t)
      -> from:('a1, 'a2, 'a3, 'a4) derived_on
      -> to_:('a1, 'a2, 'a3, 'a4) derived_on
      -> local_ ('a1, 'a2, 'a3, 'a4, 'a1_diff, 'a2_diff, 'a3_diff, 'a4_diff) t
                  Optional_diff.t
    ...
    val of_list_exn
      ...
      -> ('a3_diff list -> local_ 'a3_diff Optional_diff.t)
      -> ('a3 -> 'a3_diff -> 'a3)
      -> ('a4_diff list -> local_ 'a4_diff Optional_diff.t)
      -> ('a4 -> 'a4_diff -> 'a4)
  ...
  module For_inlined_tuple : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a3 -> to_:'a3 -> local_ 'a3_diff Optional_diff.t)
        -> (from:'a4 -> to_:'a4 -> local_ 'a4_diff Optional_diff.t)
        -> from:local_ ('a1, 'a2, 'a3, 'a4) derived_on
        -> to_:local_ ('a1, 'a2, 'a3, 'a4) derived_on
        -> local_ ('a1, 'a2, 'a3, 'a4, 'a1_diff, 'a2_diff, 'a3_diff, 'a4_diff) t
                    Optional_diff.t
...
module Tuple5 : sig
  ...
  module Diff : sig
    ...
    val get
      ...
      -> (from:'a3 -> to_:'a3 -> local_ 'a3_diff Optional_diff.t)
      -> (from:'a4 -> to_:'a4 -> local_ 'a4_diff Optional_diff.t)
      -> (from:'a5 -> to_:'a5 -> local_ 'a5_diff Optional_diff.t)
    ...
    val of_list_exn
      ...
      -> ('a4_diff list -> local_ 'a4_diff Optional_diff.t)
      -> ('a4 -> 'a4_diff -> 'a4)
      -> ('a5_diff list -> local_ 'a5_diff Optional_diff.t)
      -> ('a5 -> 'a5_diff -> 'a5)
      -> ('a1, 'a2, 'a3, 'a4, 'a5, 'a1_diff, 'a2_diff, 'a3_diff, 'a4_diff, 'a5_diff) t
           list
      -> local_ ( 'a1
  ...
  module For_inlined_tuple : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a4 -> to_:'a4 -> local_ 'a4_diff Optional_diff.t)
        -> (from:'a5 -> to_:'a5 -> local_ 'a5_diff Optional_diff.t)
        -> from:local_ ('a1, 'a2, 'a3, 'a4, 'a5) derived_on
        -> to_:local_ ('a1, 'a2, 'a3, 'a4, 'a5) derived_on
        -> local_ ( 'a1
                    , 'a2
                    , 'a3
                    , 'a4
      ...
      val apply_exn
        ...
        -> ('a4 -> 'a4_diff -> 'a4)
        -> ('a5 -> 'a5_diff -> 'a5)
        -> local_ ('a1, 'a2, 'a3, 'a4, 'a5) derived_on
        -> ('a1, 'a2, 'a3, 'a4, 'a5, 'a1_diff, 'a2_diff, 'a3_diff, 'a4_diff, 'a5_diff) t
        -> local_ ('a1, 'a2, 'a3, 'a4, 'a5) derived_on
...
module Tuple6 : sig
  ...
  module Diff : sig
    ...
    val get
      ...
      -> (from:'a4 -> to_:'a4 -> local_ 'a4_diff Optional_diff.t)
      -> (from:'a5 -> to_:'a5 -> local_ 'a5_diff Optional_diff.t)
      -> (from:'a6 -> to_:'a6 -> local_ 'a6_diff Optional_diff.t)
    ...
    val of_list_exn
      ...
      -> ('a5_diff list -> local_ 'a5_diff Optional_diff.t)
      -> ('a5 -> 'a5_diff -> 'a5)
      -> ('a6_diff list -> local_ 'a6_diff Optional_diff.t)
      -> ('a6 -> 'a6_diff -> 'a6)
      -> ( 'a1
           , 'a2
           , 'a3
  ...
  module For_inlined_tuple : sig
    ...
    module Diff : sig
      ...
      val get
        ...
        -> (from:'a5 -> to_:'a5 -> local_ 'a5_diff Optional_diff.t)
        -> (from:'a6 -> to_:'a6 -> local_ 'a6_diff Optional_diff.t)
        -> from:local_ ('a1, 'a2, 'a3, 'a4, 'a5, 'a6) derived_on
        -> to_:local_ ('a1, 'a2, 'a3, 'a4, 'a5, 'a6) derived_on
        -> local_ ( 'a1
                    , 'a2
                    , 'a3
                    , 'a4
      ...
      val apply_exn
        ...
        -> ('a5 -> 'a5_diff -> 'a5)
        -> ('a6 -> 'a6_diff -> 'a6)
        -> local_ ('a1, 'a2, 'a3, 'a4, 'a5, 'a6) derived_on
        -> ( 'a1
             , 'a2
             , 'a3
             , 'a4
